...
export const EVENT_STATUS_TO_ACTIVITY_TYPE = {
  [EVENT_STATUS.NOT_STARTED]: ACTIVITY_TYPES.EVENT_NOT_STARTED,
  [EVENT_STATUS.IN_PROGRESS]: ACTIVITY_TYPES.EVENT_IN_PROGRESS,
  [EVENT_STATUS.COMPLETED]: ACTIVITY_TYPES.EVENT_COMPLETED,
  [EVENT_STATUS.CANCELLED]: ACTIVITY_TYPES.EVENT_CANCELLED,
} as const;
...
export const NUM_DAYS_GENERATE_EVENTS_IN_ADVANCE = 7;
